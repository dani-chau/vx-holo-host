    ...
    public class DualMonitorApplicationManager : MonoBehaviour
    {
        ...
        public void StartProcess()
        {
            try
            {
                ...
                Calibration cal = CalibrationSystem.Get(0);
                Debug.Log($"calibrations found: {CalibrationSystem.CalibrationCount}");
                ...
                process.StartInfo.ArgumentList.Add(cal.screenWidth.ToString());
                process.StartInfo.ArgumentList.Add("-screen-height");
                process.StartInfo.ArgumentList.Add(cal.screenHeight.ToString());
#endif
