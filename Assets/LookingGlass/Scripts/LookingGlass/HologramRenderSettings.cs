...
namespace LookingGlass {
    ...
    public struct HologramRenderSettings : ISerializationCallbackReceiver {
        ...
        public static QuiltPreset CalculateAutomaticQuiltPreset(Calibration calibration) {
            DeviceType type = calibration.GetDeviceType();
            DeviceSettings settings = DeviceSettings.Get(type);
            return settings.quiltPreset;
        }
