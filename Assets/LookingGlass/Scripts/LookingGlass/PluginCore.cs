...
namespace LookingGlass {
    ...
    //        return str.ToString();
    //    }
    //    public static string GetLKGName(int dev_index) {
    //        StringBuilder str = new StringBuilder(100);
    ...
    //                Debug.LogError("Found Looking Glass Bridge " + bridgeVersion + ", but " + requiredVersion + " or newer is required! Download the latest version from https://look.glass/bridge");
    //                return error;
    //            }

    //            if (bridgeVersion < warningVersion) {
    //                Debug.LogWarning("We recommend using version 2.0.9 or higher of Looking Glass Bridge. You can download the latest version at https://look.glass/bridge");
    //            }
    ...
    //            float pitch = hpc_GetDevicePropertyFloat(i, "/calibration/pitch/value");
    //            float slope = hpc_GetDevicePropertyFloat(i, "/calibration/slope/value");
